...
/**
 * Base class that represents a row from the 'speciality' table.
 *
 * 
 *
 ...
 */
abstract class BaseSpeciality extends BaseObject  implements Persistent {


  const PEER = 'SpecialityPeer';
	...
	/**
	 * Initializes internal state of BaseSpeciality object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Speciality The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SpecialityPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SpecialityPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = SpecialityPeer::NUM_COLUMNS - SpecialityPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Speciality object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SpecialityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseSpeciality:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			SpecialityPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseSpeciality:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSpeciality:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseSpeciality:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			SpecialityPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SpecialityPeer::doInsert($this, $con);
					...
					$affectedRows += SpecialityPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SpecialityPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SpecialityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SpecialityPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SpecialityPeer::ID)) $criteria->add(SpecialityPeer::ID, $this->id);
		if ($this->isColumnModified(SpecialityPeer::NAME)) $criteria->add(SpecialityPeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SpecialityPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Speciality (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Speciality Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SpecialityPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SpecialityPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Speciality has previously been saved, it will retrieve
	 * related Workers from storage. If this Speciality is new, it will return
		...
		if ($this->collWorkers === null) {
			if ($this->isNew()) {
			   $this->collWorkers = array();
				...
				$criteria->add(WorkerPeer::SPECIALITY_ID, $this->id);
	 ...
	 * Otherwise if this Speciality is new, it will return
	 * an empty collection; or if this Speciality has previously
	 * been saved, it will retrieve related Workers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Speciality.
	 */
	 ...
	 * actually need in Speciality.
	 */
	public function getWorkersJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(SpecialityPeer::DATABASE_NAME);
		}
		...
		if ($this->collWorkers === null) {
			if ($this->isNew()) {
				...
				$this->collWorkers = WorkerPeer::doSelectJoinRegion($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Speciality has previously been saved, it will retrieve
	 * related Employers from storage. If this Speciality is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collEmployers === null) {
			if ($this->isNew()) {
			   $this->collEmployers = array();
				...
				$criteria->add(EmployerPeer::SPECIALITY_ID, $this->id);
	 ...
	 * actually need in Speciality.
	 */
	public function getEmployersJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(SpecialityPeer::DATABASE_NAME);
		}
		...
		if ($this->collEmployers === null) {
			if ($this->isNew()) {
				...
				$this->collEmployers = EmployerPeer::doSelectJoinRegion($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSpeciality:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSpeciality::%s', $method));
    }
