...
abstract class BaseBranchPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new BranchMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseBranchPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseBranchPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseBranchPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseBranchPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseBranchPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseBranchPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseBranchPeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the BranchPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the BranchPeer class:
//
// Propel::getDatabaseMap(BranchPeer::DATABASE_NAME)->addTableBuilder(BranchPeer::TABLE_NAME, BranchPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseBranchPeer::DATABASE_NAME)->addTableBuilder(BaseBranchPeer::TABLE_NAME, BaseBranchPeer::getMapBuilder());
