...
abstract class BaseJobType extends BaseObject  implements Persistent {
  ...
  const PEER = 'JobTypePeer';
	...
	/**
	 * Initializes internal state of BaseJobType object.
	 * @see        applyDefaults()
	 */
	 ...
	 * related Workers from storage. If this JobType is new, it will return
		...
		if ($this->collWorkers === null) {
			if ($this->isNew()) {
			   $this->collWorkers = array();
				...
				$criteria->add(WorkerPeer::JOB_TYPE_ID, $this->id);
