  ...
  const PEER = 'BranchPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = BranchPeer::NUM_COLUMNS - BranchPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * related Workers from storage. If this Branch is new, it will return
		...
		if ($this->collWorkers === null) {
			if ($this->isNew()) {
			   $this->collWorkers = array();
				...
				$criteria->add(WorkerPeer::BRANCH_ID, $this->id);
